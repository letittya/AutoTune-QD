"""
compile_1D_summary.py
─────────────
Scans all 12 test folders in testing_1D/results/, extracts the physics matrices 
...
RESULTS_DIR = os.path.join("testing_1D", "results")
...
if summary_data:
    ...
    print(f"\nSUCCESS! Aggregated {len(summary_data)} tests.")
