# same code as 1D_extraction.py but changed apths and plot saving/displays
...
#added here the virtual gate computation to bypass the other script
    v1 = np.array([1.0, np.mean(diag_slopes)]) # Diagonal step
    v1 = v1 / np.linalg.norm(v1)
    v2 = np.array([1.0, np.mean(steep_slopes)]) # Steep step
